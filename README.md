...
The code is widely deployed within Perl applications though popular modules that use it, including [Starman](https://metacpan.org/pod/Starman), [Starlet](https://metacpan.org/pod/Starlet), [Furl](https://metacpan.org/pod/Furl).
